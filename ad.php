        ...
        <div class="top-nav_content container">
            ...
            <ul class="top-nav_list">
                ...
                <?php if (isset($_user_data['ID'])) { ?>
                    <li class="top-nav_item2"><a href="account.php"><i class="fas fa-user fa-lg"></i>&nbsp; <?php echo $_user_data['Username'] ?></a></li>
    ...
    <nav class="bottom-nav">
        <div class="bottom-nav_content container">
            <ul class="bottom-nav_list">
                ...
                <li class="bottom-nav_lastitem"><a class="highlight-dark-yellow" <?php if (isset($_user_data['ID'])) { ?> href="ad.php" <?php } else { ?> href="login.php" <?php } ?>>Place an Ad</a></li>
            </ul>
        </div>
    </nav>
    <footer class="footer">
