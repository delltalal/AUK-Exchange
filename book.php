...
<body>
    ...
    <header class="header">
        <div class="header_content container">
            ...
            <p class="header_info">
                ...
                ongoing courses! For more details and how to contact seller. Click the item for more information.
            </p>
        </div>
    </header>
    <main class="container">
        ...
        <div class="organize-item-card">
            <?php
            $resultii = mysqli_query($con, "SELECT * FROM listings INNER JOIN accounts ON listings.account_fk = accounts.ID WHERE Category LIKE 'Textbook'");
            if (!$resultii) {
