...
<body>
  ...
  <section class="signupFormContainer container">
    ...
    <form class="signupForm" id="signupForm" action="signup.php" method="POST">
      ...
      <input type="number" name="number" class="signupbox" id="signupphoneNumber" placeholder="Phone Number" required />
      <input type="password" name="password" class="signupbox" id="signupPassword" placeholder="Password" required />
